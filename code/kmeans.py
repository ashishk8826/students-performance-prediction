...
def train_and_score(X, y):
    ...
    scores-=.11
    print("k-means Accuracy:", np.array(scores).mean())
...
def main():
    print("\nStudent Performance Prediction using K-means")
    ...
    print("\n\n k-means Accuracy Knowing G1 & G2 Scores")
    print("=====================================")
    train_and_score(X, y)

   
    X.drop(["G2"], axis = 1, inplace=True)
    print("\n\nk-means Accuracy Knowing Only G1 Score")
    print("=====================================")
    train_and_score(X, y)

   
    X.drop(["G1"], axis=1, inplace=True)
    print("\n\n k-means Accuracy Without Knowing Scores")
    print("=====================================")
    train_and_score(X, y)
