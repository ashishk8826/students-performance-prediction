...
def train_and_score(X, y):
    ...
    print("chaotic-SSA Model Accuracy:", np.array(scores).mean())
...
def main():
    print("\nStudent Performance Prediction using chaotic-SSA")
    ...
    print("\n\nchaotic-SSA Accuracy Knowing G1 & G2 Scores")
    print("=====================================")
    train_and_score(X, y)

   
    X.drop(["G2"], axis = 1, inplace=True)
    print("\n\nchaotic-SSA Accuracy Knowing Only G1 Score")
    print("=====================================")
    train_and_score(X, y)

   
    X.drop(["G1"], axis=1, inplace=True)
    print("\n\nchaotic-SSA Accuracy Without Knowing Scores")
    print("=====================================")
    train_and_score(X, y)
